    ...
    public partial class EnterProjectionForm : MapWindowForm
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (!proj.ImportFromProj4(text))
            {
                ...
                {
                    MessageService.Current.Info("未输入有效的proj4或WKT字符串。");
                    return;
                }
            }
            ...
            {
                MessageService.Current.Warn("无法初始化投影。");
                return;
            }
            ...
            {
                MessageService.Current.Info("输入的投影字符串已存在。");
                return;
            }
            ...
            if (list.Any())
            {
                ...
                MessageService.Current.Info("此投影字符串已绑定到另一个EPSG代码: " +
