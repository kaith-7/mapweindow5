...
namespace MW5.Tools.Controls.Parameters.Input
{
    ...
    internal partial class LayerParameterControl : InputParameterControlBase
    {
        ...
        {
            if (_currentLayer != null && DefaultSelectedIndex == 0)
            {
            ...
            {
                comboBoxAdv1.SelectedIndex = DefaultSelectedIndex;
            }
        }
        ...
        {
            throw new NotSupportedException("不支持设置值的方法。");
        }
        ...
        {
            lblNumSelected.Text = @"已选择的要素数量: " + count;
