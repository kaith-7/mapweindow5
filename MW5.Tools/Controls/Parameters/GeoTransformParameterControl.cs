// -------------------------------------------------------------------------------------------
// <copyright file="GeoTransformParameterControl.cs" company="MapWindow OSS Team - www.mapwindow.org">
...
namespace MW5.Tools.Controls.Parameters
{
    ...
    /// </summary>
    public partial class GeoTransformParameterControl : ParameterControlBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringParameterControl"/> class.
        /// </summary>
        public GeoTransformParameterControl()
        {
            InitializeComponent();
        }
