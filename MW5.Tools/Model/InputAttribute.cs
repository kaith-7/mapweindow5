...
namespace MW5.Tools.Model
{
    ...
    public class InputAttribute : Attribute
    {
        ...
        public InputAttribute(string displayName, int index, bool optional = false, bool canEmpty = false, int selectedIndex = 0)
        {
        ...
        public InputAttribute(string displayName, int index, string sectionName, int selectedIndex = 0)
        {
            DisplayName = displayName;
            Index = index;
            Optional = true;
