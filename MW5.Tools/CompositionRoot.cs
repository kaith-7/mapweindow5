...
namespace MW5.Tools
{
    ...
    internal static class CompositionRoot
    {
        ...
        public static void Compose(IApplicationContainer container)
        {
            ...
            EnumHelper.RegisterConverter(new PolygonCenterValidityConverter());
            EnumHelper.RegisterConverter(new TopologyRuleValidityConverter());
            EnumHelper.RegisterConverter(new CoordinatesDisplayValidityConverter());
            EnumHelper.RegisterConverter(new SpatialRelationValidityConverter());
        }
    }
}