...
namespace MW5.Tools.Views
{
    ...
    public partial class ToolView : GisToolViewBase, IToolView
    {
        ...
        {
            _generator.GenerateIntoPanel(panelRequired, "输出", FilterSingle(parameters, ParameterGroup.Output));

            _generator.GenerateIntoPanel(panelRequired, "输入", FilterSingle(parameters, ParameterGroup.Input));

            _generator.GenerateIntoPanel(panelOptional, "可选的", FilterSingle(parameters, ParameterGroup.Optional));
        }
        ...
        {
            _generator.GenerateIntoPanel(panelRequired, "输出", FilterBatch(parameters, ParameterGroup.Output), true);

            _generator.GenerateIntoPanel(panelRequired, "输入", FilterBatch(parameters, ParameterGroup.Input), true);

            _generator.GenerateIntoPanel(panelOptional, "可选的", FilterBatch(parameters, ParameterGroup.Optional), true);

            _generator.GenerateIntoPanel(panelOptional, "必要的", FilterBatch(parameters, ParameterGroup.Required), true);
