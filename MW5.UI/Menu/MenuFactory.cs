...
namespace MW5.UI.Menu
{
    public class MenuFactory
    {
        ...
        private static void CreateDefaultMenuItems(IMenuBase menu)
        {
            ...
            items.AddDropDown(Resources.File, MainMenuKeys.File, PluginIdentity.Default);
            items.AddDropDown(Resources.View, MainMenuKeys.View, PluginIdentity.Default);
            items.AddDropDown(Resources.Map, MainMenuKeys.Map, PluginIdentity.Default);
            items.AddDropDown(Resources.Layer, MainMenuKeys.Layer, PluginIdentity.Default);
            items.AddDropDown(Resources.Plugins, MainMenuKeys.Plugins, PluginIdentity.Default);
            items.AddDropDown(Resources.Tiles, MainMenuKeys.Tiles, PluginIdentity.Default);
            items.AddDropDown(Resources.Tools, MainMenuKeys.Tools, PluginIdentity.Default);
            items.AddDropDown(Resources.Help, MainMenuKeys.Help, PluginIdentity.Default);
