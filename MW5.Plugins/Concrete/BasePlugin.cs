...
#pragma warning disable 67
        ...
        internal EventHandler<AttributeCheckResultEntryAddArgs> CheckAttrEntryAdded_;
        internal EventHandler<TopologyCheckResultEntryAddArgs> TopologyCheckEntryAdded_;
        internal EventHandler<MenuItemEventArgs> ItemClicked_;
        internal EventHandler<MenuItemEventArgs> ItemDoubleClicked_;
        ...
        public event EventHandler<AttributeCheckResultEntryAddArgs> CheckAttrEntryAdded
        {
            add { CheckAttrEntryAdded_ += value; }
            remove { CheckAttrEntryAdded_ -= value; }
        }
        ...
        public event EventHandler<MenuItemEventArgs> ItemDoubleClicked
        {
            add { ItemDoubleClicked_ += value; }
            remove { ItemDoubleClicked_ -= value; }
        }
        ...
        //public event MapEventHandler<SelectBoxFinalEventArgs> SelectBoxFinal;
        public event MapEventHandler<ShapeHightlightedEventArgs> ShapeHighlighted_;
        ...
        {
            add { ShapeHighlighted_ += value; }
            remove { ShapeHighlighted_ -= value; }
        }
