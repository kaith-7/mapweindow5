...
namespace MW5.Plugins.Concrete
{
    ...
    public class AppConfig
    {
        ...
        private List<int> _lastChooseProjections;
        ...
        [DataMember]
        public List<int> LastChooseProjections
        {
            get { return _lastChooseProjections ?? (_lastChooseProjections = new List<int>()); }
            set { _lastChooseProjections = value; }
        }
        ...
        public void SetDefaults()
        {
            ...
            ScalebarUnits = ScalebarUnits.Metric;
