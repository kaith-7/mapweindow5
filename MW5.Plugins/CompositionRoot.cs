...
namespace MW5.Plugins
{
    internal static class CompositionRoot
    {
        public static void Compose(IApplicationContainer container)
        {
            ...
            EnumHelper.RegisterConverter(new SpatialSelectionModeConverter());
            EnumHelper.RegisterConverter(new LengthDisplayConverter());
            EnumHelper.RegisterConverter(new AngleFormatConverter());
            EnumHelper.RegisterConverter(new AreaDisplayConverter());
        }
    }
}
