    ...
    public partial class AttributeView : AttributesViewBase, IAttributeView
    {
        ...
        public Dictionary<int, string> Values
        {
            get
            {
                ...
                var list = tableLayoutPanel1.Controls.OfType<Control>().Where(t => t.Enabled && 
                (t is TextBox || t is ComboBox || t is DateTimePicker));
            ...
            for (int i = 0; i < numFields; i++)
            {
                ...
                switch (field.Type)
                {
                    case AttributeType.Boolean:
                        ...
                        box.Items.AddRange(new string[]{ "否", "是" });
                        box.SelectedIndex = 0;
                        control = box;
                        break;
                    case AttributeType.Date:
                        ...
                        break;
                    default:
                        control = new TextBox() { ReadOnly = !editing, Text = value.ToString() };
                        break;
                }
