...
namespace MW5.Plugins.AttributeChecker.Controls
{
    public partial class CheckAttributesDataGridView : StronglyTypedDataGridView<ILayerCheckResult>, IItemFilter<ILayerCheckResult>
    {
        ...
        /// </summary>
        public bool Include(ILayerCheckResult item)
        {
            ...
            {
                return item.ErrorMessage.ContainsIgnoreCase(_searchToken);
            }

            return true;
        }

        public void SetDatasource(BindingListView<ILayerCheckResult> entries)
        {
        ...
        private void UpdateColumns()
        {
            ...
            var cmn2 = Adapter.GetColumn(e => e.ErrorMessage);
            //cmn2.DisplayIndex = 1;
