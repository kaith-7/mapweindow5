...
namespace MW5.Plugins.TopologyChecker.Menu
{
    ...
    {
        //private const string ShapeEditorToolbar = "编辑矢量";    // perhaps simply use plugin name as a default
        
        private readonly MenuCommands _commands;

        private IToolbar _toolbar;

        public MenuGenerator(IAppContext context, TopologyCheckerPlugin plugin)
        {
        ...
        private void InitToolbar(IAppContext context, PluginIdentity identity)
        {
            ...
            //items.AddButton(_commands[MenuKeys.CopyAttributes], true);
            //items.AddButton(_commands[MenuKeys.PasteAttributes], true);
            ...
            //var dropDown = items.AddDropDown("多边形叠加", MenuKeys.PolygonOverlayDropDown, identity);
        ...
        private void InitMenu(IAppContext context, PluginIdentity identity)
        {
            ...
            //menu.InsertBefore = context.Menu.MapMenu;
            var menu = context.Menu.MapMenu;
            menu.SubItems.AddButton(_commands[MenuKeys.ShowTopologyRulesWindow]);

            //menu.AddButton(_commands[MenuKeys.CheckTopology], true);

            //var bar = menu.AddDropDown(Resources.MainMenuEditKey, MenuKeys.MainMenuEditKey, identity);
