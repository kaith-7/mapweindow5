...
namespace MW5.Plugins.Symbology.Controls
{
    ...
    public partial class RgbBandControl : UserControl
    {
        ...
        private void SelectedBandChanged(object sender, EventArgs e)
        {
            ...
            if (bandIndex > 0 && bandIndex <= _raster.Bands.Count)
            {
                var statics = _raster.Bands[bandIndex].GetStatistics(true, true);
                bandInfo.Min.DoubleValue = statics.Min;
                bandInfo.Max.DoubleValue = statics.Max;
            ...
            {
                bandInfo.Min.DoubleValue = double.NaN;
                bandInfo.Max.DoubleValue = double.NaN;
            }
        ...
        private void ComputeBandMinMax(RasterBand band, BandInfo bandInfo)
        {
            ...
            var statics =  band.GetStatistics(true, true);
            {
                bandInfo.Min.DoubleValue = statics.Min;
                bandInfo.Max.DoubleValue = statics.Max;
            }
