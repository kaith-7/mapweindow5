...
namespace MW5.Plugins.Symbology.Views
{
    ...
    public partial class VectorStyleView : VectorStyleViewBase, IVectorStyleView
    {
        ...
        private void InitGeneralTab()
        {
            ...
            var filename = Model.FeatureSet != null && !string.IsNullOrEmpty(Model.FeatureSet.UnProjectedFilename) ?
                Model.FeatureSet.UnProjectedFilename :
                string.IsNullOrWhiteSpace(Model.Filename) ? "<not defined>" : Model.Filename;
