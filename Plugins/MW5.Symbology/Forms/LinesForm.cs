...
namespace MW5.Plugins.Symbology.Forms
{
    public partial class LinesForm : MapWindowForm
    {
        ...
        private void Initialize()
        {
            ...
            cboOrientation.Items.Add("横向");
            cboOrientation.Items.Add("平行");
            cboOrientation.Items.Add("竖向");

            cboLineType.Items.Clear();
            cboLineType.Items.Add("线");
            cboLineType.Items.Add("标记");
        ...
        private void Options2Grid()
        {
            ...
            if (CanUseLinePattern())
            {
                ...
                {
                    dgv[CMN_TYPE, i].Value = _style.Line.Pattern[i].LineType == LineType.Simple ? "线" : "标记";
        ...
        private void cboLineType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (dgv.SelectedRows.Count > 0)
            {
                ...
                dgv[CMN_TYPE, index].Value = line.LineType == LineType.Simple ? "线" : "标记";
                Options2Ui();
                dgv.Invalidate();
                btnApply.Enabled = true;
            }
