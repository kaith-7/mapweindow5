    ...
    public partial class OptionsManagerForm : MapWindowForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (form.ShowDialog(this) == DialogResult.OK)
            {
                ...
                if (File.Exists(name))
                {
                    if (!MessageService.Current.Ask("同名选项已存在。" + Environment.NewLine + "要覆盖吗?"))
                    {
                        return;
                    }
                }
        ...
        private void btnRename_Click(object sender, EventArgs e)
        {
            ...
            if (form.ShowDialog(this) == DialogResult.OK)
            {
                ...
                {
                    MessageService.Current.Warn("重命名失败。");
                    return;
                }
        ...
        private void btnApply_Click(object sender, EventArgs e)
        {
            ...
            if (map != null)
            {
                ...
                {
                    MessageService.Current.Warn("加载选项出错。");
                }
            }
        }
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            if (map != null)
            {
                if (MessageService.Current.Ask("是否要删除图层的所有选项?"))
                {
                    int errorCount = 0;
                    ...
                    if (errorCount > 0)
                    {
                        MessageService.Current.Warn("删除选项失败: " + errorCount + Environment.NewLine + 
                                        "原因: " + map.LastError);
                    }
                }
            }
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            if (MessageService.Current.Ask("删除以下选项: " + name + "?"))
            {
                var map = _legend.Map;
                if (map != null)
                {
                    ...
                    {
                        MessageService.Current.Warn("删除选项失败。" + Environment.NewLine + "原因: " + map.LastError);
                    }
                }
            }
            RefreshControlsState();
