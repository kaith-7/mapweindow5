...
namespace MW5.Plugins.Printing.Views
{
    internal partial class LayoutView : LayoutViewBase, ILayoutView
    {
        ...
        private void OnSelectionChanged()
        {
            ...
            lblSelected.Text = @"已选择的部件: " + layoutControl1.SelectedLayoutElements.Count();
        }
        ...
        public override void UpdateView()
        {
            ...
            lblPageSize.Text = "纸张: " + layoutControl1.PrinterSettings.DefaultPageSettings.PaperSize.PaperName;
            lblPageCount.Text = string.Format("页数: {0} × {1}", layoutControl1.Pages.PageCountX,
