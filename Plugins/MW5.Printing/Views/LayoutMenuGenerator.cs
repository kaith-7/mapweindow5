...
namespace MW5.Plugins.Printing.Views
{
    internal class LayoutMenuGenerator
    {
        ...
        {
            // file
            var dropDown = _menu.Items.AddDropDown("文件", "LayoutFileDropDown", _plugin.Identity);
            ...
            // view
            dropDown = _menu.Items.AddDropDown("视图", "LayoutViewDropDown", _plugin.Identity);
            dropDown.SubItems.AddDropDown("工具栏", Plugins.Menu.MenuKeys.ViewToolbars, _plugin.Identity);
            dropDown.SubItems.AddDropDown("窗口", Plugins.Menu.MenuKeys.ViewWindows, _plugin.Identity);
            ...
            // selection
            dropDown = _menu.Items.AddDropDown("选择", "LayoutSelectionDropDown", _plugin.Identity);
            ...
            // insert
            dropDown = _menu.Items.AddDropDown("添加", "LayoutInsertDropDown", _plugin.Identity);
        ...
        {
            // insert
            var bar = _toolbars.Add("添加部件工具", LayoutMenuKeys.InsertToolbar, _plugin.Identity);
            ...
            // map
            bar = _toolbars.Add("地图操作工具", LayoutMenuKeys.MapToolbar, _plugin.Identity);
            bar.DockState = ToolbarDockState.Left;
            ...
            // main
            bar = _toolbars.Add("基础工具", LayoutMenuKeys.MainToolbar, _plugin.Identity);
            ...
            // zoom
            bar = _toolbars.Add("缩放工具", LayoutMenuKeys.ZoomToolbar, _plugin.Identity);
            ...
            bar.Items.AddLabel("缩放比例:", LayoutMenuKeys.ZoomComboLabel, _plugin.Identity).BeginGroup = true;
