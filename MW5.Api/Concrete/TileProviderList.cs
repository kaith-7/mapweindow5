...
namespace MW5.Api.Concrete
{
    public class TileProviderList: IEnumerable<TileProviderInfo>, IComWrapper
    {
        ...
        public bool AddCustom(int id, string name, string urlPattern, TileProjection projection, int minZoom = 0, int maxZoom = 17, bool isGCJ02 = false, bool reverseY = false)
        {
            return _providers.Add(id, name, urlPattern, (tkTileProjection)projection, minZoom, maxZoom, isGCJ02, reverseY);
        }
