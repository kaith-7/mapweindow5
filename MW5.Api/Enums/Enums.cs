namespace MW5.Api.Enums
{
    ...
    public enum TopologyRule
    {
        None = -1,
        PointNotDuplicate,
        PointPointNotDuplicate,
        PointOverlapLineEnds,
        PointOverlapLine,
        PointOnPolygonBoundary,
        PointInPolygonNotBoundary,
        PointInPolygonAndBoundary,
        ...
        LineLineNotOverlaps,
        LineLineNotIntersect,

        LineInPolygon,
        PolygonNotOverlaps,
        PolygonNoMultiParts,
        PolygonBoundaryMustOverlapsByLines, // 面边界必须有与之重合的线要素
        PolygonMustBeCovredBy,  // 被包含
        PolygonMustNotOverlapWith, // 无重叠部分
        PolygonMustPartOverlapWith, // 部分重叠
