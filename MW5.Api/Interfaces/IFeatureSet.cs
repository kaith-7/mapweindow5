...
namespace MW5.Api.Interfaces
{
    ...
    {
        string UnProjectedFilename { get; set; }
        ...
        bool SaveAs(string shapefileName, bool switchToNew);
        ...
        IFeatureSet Reproject(ISpatialReference newProjection, double[] transformParams, out int reprojectedCount);
        IFeatureSet FixUpShapes(bool selectedOnly);
        IFeatureSet AttributeCopy(IFeatureSet fsOverlay);
        ...
        long UnProjectedID(int ShapeIndex);
        bool Deleted(int ShapeIndex);
