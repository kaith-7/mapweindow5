    ...
    public class MainPresenter : BasePresenter<IMainView>
    {
            ...
            : base(view)
        {
            ...
            try
            {
                ...
                appContext.InitPlugins(configService, p => SplashView.Instance.ShowStatus($"加载插件: {p.Name}"));
        ...
        private void ViewShown(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Program.ProjectFileName))
            {
                try
                {
                    _projectService.Open(Program.ProjectFileName, true);
                }
                catch (Exception ex)
                {
