...
namespace MW5.Menu
{
    ...
    {
        private const string NoTilesMenuItem = "无地图切片";
        ...
        private static void AddDefaultProviders(IDropDownMenuItem root)
        {
            var list = new[]
            {
                ...
                //TileProvider.OpenTransportMap,
                //TileProvider.OpenHumanitarianMap,
                //TileProvider.OpenCycleMap,
                TileProvider.GoogleMaps,
                TileProvider.GoogleSatellite,
                //TileProvider.GoogleTerrain,
                //TileProvider.MapQuestAerial,
                TileProvider.BingMaps,
                TileProvider.BingHybrid,
