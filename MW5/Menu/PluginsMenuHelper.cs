...
namespace MW5.Menu
{
    internal static class PluginsMenuHelper
    {
        ...
        internal static void Init(IAppContext context, IPluginManager pluginManager)
        {
            ...
            //{
            //    _manager.LoadPlugin(p.Identity, Enumerable.Empty<string>().ToDictionary(s => s), _context);
            //}
            //menuItem.Update();
        }
        ...
        private static void MenuDropDownOpening(object sender, EventArgs e)//下拉菜单
        {
            ClearPlugins();
        ...
        private static void OnItemClick(object sender, MenuItemEventArgs e)//点击菜单项
        {
