...
namespace MW5.Gdal.Views
{
    public class GdalView: ToolView, IGdalView
    {
        ...
        public override void Initialize()
        {
            ...
            _tabCmdLine = tabControlAdv1.AddTab("命令行", Resources.img_console24);
        }
        ...
        {
            _cmdOptions = new StringParameterControl(true) { Caption = "主要选项", Dock = DockStyle.Top, ReadOnly = true };
            var section = new ConfigPanelControl { HeaderText = "命令行选项",  Dock = DockStyle.Top };
        ...
        private void InitializeComponent()
        {
            ...
            // tabControlAdv1
            // 
            this.tabControlAdv1.BeforeTouchSize = new System.Drawing.Size(650, 390);
            this.tabControlAdv1.Size = new System.Drawing.Size(650, 390);
            // 
            // GdalView
            // 
